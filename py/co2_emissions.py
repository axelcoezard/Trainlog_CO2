...
class TravelEmissions:
    ...
    default_factors = {
        ...
        "train": {"amont": 5, "fabrication": 5, "infra": 6.5},
    ...
    def train(self, segments: list, passengers: int = 1) -> float:
        ...
        amont_fab_total = sum(dist * (self.default_factors['train']['amont'] + self.default_factors['train']['fabrication']) for dist, _ in segments)
        return (infra_total + amont_fab_total) / passengers / 1000
